...
import org.aditi.restwebservices.messenger.resources.bean.MessageFilterBean;
import org.aditi.restwebservices.messenger.services.MessageService;
...
public class MessageResource
{
	...
	{
		//Demo for using headervalues for setting status etc.
		Message newMessage = messageService.addMessage(message);
		String newId = String.valueOf(newMessage.getId());
		URI uri = uriInfo.getAbsolutePathBuilder().path(newId).build();
		
		//returns complete path, and all reponse related parameters can be added accordingly
